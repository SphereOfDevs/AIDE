...
> AI agent operating manual | Created: {{DATE}}

## Project Vision

{{PROJECT_NAME}} is built spec-driven: every feature starts as a written specification, passes review, then gets implemented and validated. AI agents are engineering collaborators, not autonomous coders.
